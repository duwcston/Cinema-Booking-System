...
<html>
	...
	<body style="background-color: powderblue; font-family: monospace; margin: 0; padding: 0;">
		...
		<?php
			...
			$sql2="SELECT t_name,time,location,show_id,s.seats,s.price from theater t,shows s,movie m where m.mov_name='".$_SESSION['mov_name']."' and t.t_id=s.t_id and s.mov_id=m.mov_id;";
			mysqli_query($conn, $sql2) or die('Error');
			$result2 = mysqli_query($conn, $sql2);
			echo '<br><br><table style="margin-left: 10%; margin-right: 5%; background-color:black; color:white;">
					<tr>
						...
						<td align="middle"><u><b>Price</b></u></td>
